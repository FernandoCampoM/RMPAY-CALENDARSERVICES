...
import com.retailmanager.rmpayCalendar.services.services.ScheduleCalendar.StoreConfig.IStoreConfigService;
...
public class StoreConfigController {
    ...
    @Autowired
    private IStoreConfigService service;

    @PostMapping
    public ResponseEntity<?> save(@Valid @RequestBody StoreConfigDTO dto) {
        return service.save(dto);
    }

    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable @Positive Long id,
                                    @Valid @RequestBody StoreConfigDTO dto) {
